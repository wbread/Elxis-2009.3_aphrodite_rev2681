...
class contact_item_link_menu_html {
	...
	/********************************/
	static public function edit( &$menu, &$lists, &$params, $option, $contact ) {
...
?>
		...
		function submitbutton(pressbutton) {
			...
			if (trim(form.name.value) == ""){
				...
				alert( "<?php echo $adminLanguage->A_CMP_MU_SELCONT; ?>" );
			} else {
		...
		<tr>
			<th>
                ...
                <?php echo $adminLanguage->A_CMP_MU_MITEM.' :: '.$adminLanguage->A_CMP_MU_MILCI; ?>
			</th>
		</tr>
		</table>
		...
		<tr valign="top">
			<td width="50%">
				...
				<tr>
					<td valign="top"><?php echo $adminLanguage->A_CMP_MU_CONLINK; ?>:</td>
					<td>
