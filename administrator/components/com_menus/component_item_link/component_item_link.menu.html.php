...
?>
        ...
        function submitbutton(pressbutton) {
            ...
            if ( trim(form.name.value) == "" ){
                ...
                alert( "<?php echo $adminLanguage->A_CMP_MU_SCITLKT; ?>" );
            } else {
                submitform( pressbutton );
            }
        }
        ...
        <tr>
            <th>
                ...
                <?php echo $adminLanguage->A_COMP_MENUS_MENU_ITEM.' : '.$adminLanguage->A_CMP_MU_MILCMPI; ?>
            </th>
        </tr>
        </table>
		...
		<tr valign="top">
			<td width="50%">
				...
				<tr>
					<td valign="top"><?php echo $adminLanguage->A_CMP_MU_COMPLLTO; ?>:</td>
					<td>
