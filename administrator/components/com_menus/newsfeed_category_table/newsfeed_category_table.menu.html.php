...
?>
		...
		<tr>
			<th>
                ...
                <?php echo $adminLanguage->A_CMP_MU_MITEM.' :: '.$adminLanguage->A_CMP_MU_MITBNFC; ?>
			</th>
		</tr>
		</table>
		<table width="100%">
			...
			<td width="50%">
				...
				<tr>
					...
					<td>
                        ...
                        <?php if ( !$menu->id ) { echo mosToolTip( $adminLanguage->A_CMP_MU_CCTBLANK ); } ?>					
                    </td>
				</tr>
				<tr>
		...
		<script type="type/javascript" src="<?php echo $mainframe->getCfg('live_site'); ?>/includes/js/overlib_mini.js"></script>
<?php 
	}
}
?>