...
protected $AX_TLBT = 'Display an automatic translation icon? Requires Bot Translate to be published. For the global setting see the bot parameters';
protected $AX_ADDH = 'Display AddThis (addthis.com) sharing button? Requires Bot Share - AddThis to be published. For the global setting see the bot parameters';
protected $AX_EMI = 'Display E-mailit (e-mailit.com) sharing button? Requires Bot Share - E-mailit to be published. For the global setting see the bot parameters';
