<?php 
/**
* @ Version: $Id: mod_latestnews.php 1878 2008-01-25 21:26:29Z datahell $
* @ Copyright: Copyright (C) 2006-2008 Elxis.org. All rights reserved.
* @ Package: Elxis
* @ Subpackage: Module Latest News
...
global $mosConfig_offset, $mosConfig_sef, $mosConfig_live_site, $mainframe, $lang, $my;
...
if ($rows) {
    ...
    echo '<ul class="latestnews'.$class_sfx.'">'._LEND;
	foreach ( $rows as $row ) {
        $_Itemid = 0;
        $seolink = '';
        //get Itemid
		...
		<li class="latestnews<?php echo $class_sfx; ?>">
			<a href="<?php echo $link; ?>" class="latestnews<?php echo $class_sfx; ?>" title="<?php echo $row->title; ?>"><?php echo $row->title; ?></a>
		</li>
<?php 
	}
    echo '</ul>'._LEND;
