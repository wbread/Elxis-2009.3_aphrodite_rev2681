...
if ( !isset($elxis_root) ) {
    $elxis_root = str_replace( '/mambots/editors/tinymce/jscripts/tiny_mce/plugins/ibrowser/scripts/phpThumb', '', str_replace( DIRECTORY_SEPARATOR, '/', dirname(__FILE__) ) );
}
$PHPTHUMB_CONFIG['document_root'] = $elxis_root;
...
$PHPTHUMB_CONFIG['cache_directory'] = $elxis_root.'/cache/';                            // set the cache directory relative to the phpThumb() installation
...
$PHPTHUMB_CONFIG['cache_source_directory'] = $elxis_root.'/cache/source/';
