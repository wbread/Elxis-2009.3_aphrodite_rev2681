...
* @author: Elxis Team
* @translator: Žan Anđić, Dario Žujić, Dejan Viduka
* @link: http://www.elxis-srbija.org
* @email: admin@elxis-srbija.org
* @description: Croatian user's preferable language for Elxis CMS
...
class prefLang_croatian {
	...
	public $_E_LOGINAPPR = 'Prijavite se u administratorski dio sajta kako biste ga pregledali.';
	public $_E_DONTRESPOND = 'Molimo Vas da ne odgovarate na ovu poruku jer je automatski generirana, i služi samo za Vašu informaciju.';
	public $_E_NEWPASS_SUB = "Nova lozinka za %s";
	public $_E_RPASS_NADMIN = "Korisnik %s zatražio je novu lozinku. Nova lozinka je generirana i poslana. 
	Ukoliko ne želite primati obavijesti o sličnim akcijama, postavite prrametar USERS_RPASSMAIL u SoftDisk-u na Ne.";
...
Molimo vas da ne odgovarate na ovu poruku jer je ona automatski generirana i služi za Vašu informaciju.";
	...
	public $_SUBCON_APPRNTF = 'Obaviještenje o dodanom sadržaju';
	public $_SUBCON_ATAPPR = 'Sadržaj koji ste dodali na %s je odobren.';
	public $_SECTION = 'Sekcija';
	public $_CATEGORY = 'Kategorija';
	//elxis 2008.1
	public $_MANAPPROVE = 'Kako bi se novi korisnik mogao prijaviti, potrebno je osobno aktivirati nalog!';
