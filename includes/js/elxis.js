/**
* @version $Id: elxis.js 1878 2008-01-25 21:26:29Z datahell $
* @package Elxis Javascript
* @Copyright (C) 2006-2008 Elxis.org
* @license http://www.gnu.org/copyleft/gpl.html GNU/GPL
* Elxis is Free Software
*/
...
function popupWindow(mypage, myname, w, h, scroll) {
	...
	//var win = window.open(mypage, myname, winprops); //IE8 bug
...
/**
* @param string The name of the element to show
*/
...
/**
* @param string The name of the element to hide
*/
...
function setsynitem(iid, xurl) {
	var rndnum = Math.random();
	var isynajax = new sack();
    isynajax.setVar("itemsyn", iid);
    isynajax.setVar("rndnum", rndnum);
	isynajax.requestFile = 'includes/setsyn.php';
	isynajax.method = 'GET';
	isynajax.onCompletion = function() { document.location.href = xurl; }
	isynajax.runAJAX();
}
