 ...
 * patTemplate
 *
 * $Id: patTemplate.php 1878 2008-01-25 21:26:29Z datahell $
 *
...
class patTemplate
{
	...
	*/
	function clearGlobalVars( $varname )
	{
	    $this->_globals = array();
		return	true;
	}
	...
	*/
	function _getConditionValue( $template, $value, $isVar = true )
	{
		...
		// only one iteration, use the __single condition
		if ($this->_templates[$_template]['loop'] === 1) {
