...
class SAXY_Parser_Base {
	/** @public int The current state of the parser */
	public $state;
	/** @public int A temporary container for parsed characters */
	public $charContainer;
	/** @public Object A reference to the start event handler */
	public $startElementHandler;
	/** @public Object A reference to the end event handler */
	public $endElementHandler;
	/** @public Object A reference to the data event handler */
	public $characterDataHandler;
	/** @public Object A reference to the CDATA Section event handler */
	public $cDataSectionHandler = null;
	/** @public boolean True if predefined entities are to be converted into characters */
	public $convertEntities = true;
	/** @public Array Translation table for predefined entities */
	public $predefinedEntities = array('&amp;' => '&', '&lt;' => '<', '&gt;' => '>',
							'&quot;' => '"', '&apos;' => "'");
	/** @public Array User defined translation table for entities */
