...
class php_http_response {
	...
	public $isResponseChunkDecoded = false;
	...
	*/
	function getStatusCode() {
		$statusArray = preg_split('/[\s]/', $this->statusLine);
