...
* @description: Hrvatski jezik za komponentu eBlog
...
class eBlogLang {
	...
	public $NALLPOSTCOM = 'Nije Vam dozvoljeno kometiranje!';
	public $MUSTWRITEMSG = 'Morate unijeti poruku!';
	public $COMADDSUC = 'Vaš komentar je uspješno dodan!';
	...
	public $COMMENTARY = 'Komentiranje';
	public $NOTALLOWED = 'Nedozvoljeno'; //Commentary
	public $REGUSERS = 'Registrirani korisnici'; //Commentary
	...
	public $RTLCSSFILED = 'Stil koji će Vaš blog koristiti za prikaz na jezicima koji se čitaju s desna na lijevo, kao što su persijski ili hebrejski.';
	...
	public $SIZEKBD = 'Maksimalna veličina file-ova koje je moguće dodati, dana u KB. Uobičajena vrijednost je 2000 (2MB).';
	public $BLOGOWNER = 'Vlasnik bloga';
	public $UPLOADDIR = 'Direktorij dodavanja';
	public $UPLOADEDFILES = 'Dodani file-ovi';
	...
	//elxis 2009.1
	public $INVDATE = 'Datum koji ste odabrali nije ispravan.';
	public $METADESCDAY = "Posts za %s na %s."; //Posts for DATE on EBLOG_TITLE
	public $NOPOSTSFDATE = 'Nema komentara za ovaj datum.';
	public $SHAREPOST = 'Podijeli ovaj članak';
